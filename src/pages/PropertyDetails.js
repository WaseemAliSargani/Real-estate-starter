        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'>
          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 '>
            ...
            <form className='flex flex-col gap-y-4'>
              <input
                className='border border-gray-300 focus-within:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm'
              ...
              <div className='flex gap-x-2'>
                ...
                <button className='border border-violet-700 text-violet-700 hover:border-violet-500 hover:text-violet-500 w-full rounded p-4 text-sm'>Call</button>
              </div>
            </form>
